...
- `map_form` is an allowlisted presentation hint (`building`, `street`, `district`, `city`, `mine`, `forest`, `water`, or `landmark`). It is never raw SVG and invalid/missing values use deterministic generic shapes.
